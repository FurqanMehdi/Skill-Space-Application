...
public class android_test extends AppCompatActivity {
        ...
        submitButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (isAllQuestionsAnswered(question1Group, question2Group, question3Group, question4Group, question5Group)) {
                    ...
                    Toast.makeText(android_test.this, "Submit Successfully", Toast.LENGTH_SHORT).show();

                    // Start DashboardActivity when submit button is clicked
                    Intent intent = new Intent(android_test.this, dashboard.class);
                    startActivity(intent);
                } else {
                    // Show error message if any question is unanswered
                    Toast.makeText(android_test.this, "Please answer all the questions", Toast.LENGTH_SHORT).show();
                }
            }
        }); // Set click listener for the submit button
