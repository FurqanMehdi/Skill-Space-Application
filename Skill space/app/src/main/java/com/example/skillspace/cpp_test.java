...
public class cpp_test extends AppCompatActivity {

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        EdgeToEdge.enable(this);
        setContentView(R.layout.activity_cpp_test);
            ...
            submitButton.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    ...
                    if (isAllQuestionsAnswered(question1Group, question2Group, question3Group, question4Group, question5Group)) {
                        ...
                        Toast.makeText(cpp_test.this, "Submit Successfully", Toast.LENGTH_SHORT).show();

                        // Start DashboardActivity when submit button is clicked
                        Intent intent = new Intent(cpp_test.this, dashboard.class);
                        startActivity(intent);
                    } else {
                        // Show error message if any question is unanswered
                        Toast.makeText(cpp_test.this, "Please answer all the questions", Toast.LENGTH_SHORT).show();
                    }
                }
            });
